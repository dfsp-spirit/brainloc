...
Let's say we have some query coordinates in MNI305 surface space and want to find the closest vertex in the brainparc for each of the coordinates. Here is how we can do that:
