...
#'
#' @note If you leave the file path arguments \code{talairach_vol_file} and \code{lookup_table_file} at NULL, the files will be downloaded from \code{talairach.org} automatically if that is possible (e.g., you have a working internet connection and the server is up). If it fails, the function will stop in the next step.
#'
